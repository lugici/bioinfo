...
str es estructura del objeto pones eso y entre parentesis p.ejemp protein para consultar de menera filtrada cda lista
si quiero ver lo de dentro de cada lista como lo he hecho abajo he de poner protein los corchetes y el numero
...
taxSin
```
raro que haya tantos taxones sin proteinas vinculadas a ellos, probalemente es pq entre las proteinas revisadas han dejado de añadir proteinas muy parecidas
...
```
los cocodrilos tienen 15 proteinas
:::
