...
```
se pueden pedir un monton  de campos separados por comas, para saber los que puedo pedir puedo poner la linea de data format y en vez de poner fields pongo help
...
GCF_003719485.1
GCA_003719485.1
la diferencia es en las primeras tres letrs la ultima en uno es F y en A,siendo la F del genoma de referencia curado y el A ensamblajes primarios enviados por centros de secuenciacion. diferencia entre la base de datos propia y la general.

2. Busca una función de R que te permita identificar las líneas repetidas en un
   marco de datos.
   La función duplicated() te permite identificar las filas duplicadas en un dataframe y junto con ! los puedes eliminar y conservar solo las primeras ocurrencias, de manera que, si sale FALSE no hay secuencias repetidas.
...
```
se puede ver como conforme pasan los aós hay genomas mas largos
# Archivos JSON y GFF
