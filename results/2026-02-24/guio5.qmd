...
El primer bloque no funciona, no se ejecuta, da error, la diferencia entre ambos es que el primero no tiene: URLencode.si copio la la URL y la pego en el navegador y me saca la tabla, pq el navegador es listo para diferenciar espacios y comillas. el urlENCODE ES PARA QUE NO SE DETENGA EN UN ESPACIO Y ASI LA ENTIENDA COMO UNA ENTERA.

en el tercer formato se leen y entienden mucho mejor los componentes, y puedo copiar y pegar el formato para modficar lo que quiera. el curto es para limitar los datos que me van a devolver

curl download guarda eso en un archivo de texto

las 5 variables son lloos 5 pasos en ENA, siendo query los filtros

si buscamos alcohol deshidrogenasa si ponemos coding no funciona solo funciona si ponemos sequencin que es mucho mas aplia
:::
...
1. ¿Cuántas secuencias hay con el término "alcohol dehydrogenase" en su descripción? 1259, es el número de lineas
2. ¿Qué longitudes tienen? 839
3. ¿De cuántas especies diferentes son estas secuencias? 308
4. ¿Cuándo se publicaron las más recientes? lo vemos en el filtro first_public, me sale 2022-04-03
sort lo que hace es ordenar por defecto de menor a mayoy y tail si no le dice lo contrario te da los 6 ultimos si al final de la orden tail y dentro del parentesis de sort le pomgo despues de public), n=1) y me saldra solo un resultado
:::
)
